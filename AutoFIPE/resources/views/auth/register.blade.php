<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
                ...
                >
                    ...
                    >
                        <path
                            ...
                            stroke-linejoin="round"
                            stroke-width="2"
                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm6 0c-1.5 4-5 7-9 7s-7.5-3-9-7c1.5-4 5-7 9-7s-7.5 3-9 7z"
                        />
                    </svg>
                </button>
            </div>
        ...
        <div
            class="flex items-center justify-end mt-4 text-sm text-gray-600"
            style="gap: 2px"
        >
